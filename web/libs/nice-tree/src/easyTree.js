        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    scriptName = $(this).find('div[class=item-name]').html();
                    scriptControls = $(this).find('div[class=item-controls]').html();
                    ...
                    $(this).find('div[class=item-name]').html(scriptName);
                    $(this).find('div[class=item-controls]').html(scriptControls);
